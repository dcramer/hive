!(function(t) {
  ...
  function(t, e, i) {
          ...
          switch (r.split(" ")[0]) {
            ...
            case "device":
              ...
              for (const t of window.cardToolsData.devices)
                d(n, t.name) && f(t).includes(s.entity_id) && (e = !0);
              if (!e) return !1;
              break;
            case "area":
            ...
            case "last_changed":
              if (
                !d(
                  n,
                  (new Date().getTime() - new Date(s.last_changed).getTime()) /
                    6e4
                )
              )
                return !1;
            ...
            case "last_updated":
              if (
                !d(
                  n,
                  (new Date().getTime() - new Date(s.last_updated).getTime()) /
                    6e4
                )
              )
                return !1;
    ...
    function m(t, e) {
      ...
      let i = e.type;
      if (
        ((i = i.startsWith(y) ? i.substr(y.length) : `hui-${i}-${t}`),
    ...
    customElements.define(
      ...
      class extends s {
        ...
        _getEntities() {
          ...
          if (this._config.filter.include) {
            ...
            for (const i of this._config.filter.include) {
              ...
              let s = e
                ...
                .map(t =>
                  JSON.parse(
                    JSON.stringify(new Object({ ...t, ...i.options })).replace(
                      /this.entity_id/g,
                      t.entity
                    )
                  )
                );
              void 0 !== i.sort && (s = s.sort(p(this.hass, i.sort))),
                (t = t.concat(s));
            }
          }
          ...
          if (
            this._config.sort &&
            ((t = t.sort(p(this.hass, this._config.sort))),
