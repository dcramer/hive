          ...
          (s.prototype.cacheViewBox = function() {
            ...
            if (t) {
              ...
              (this.activeState.zoom = n),
                (this.activeState.x =
                  (this.options.width - this.viewBox.width * n) / 2),
                (this.activeState.y =
                  (this.options.height - this.viewBox.height * n) / 2),
                ...
                o === !1
                  ...
                  : i.isObject(o) &&
                    (o.x === !1
                      ...
                      : i.isNumber(o.x) && (t.e = o.x),
                    o.y === !1
                      ? ((t.f = this.getPan().y), (r = !0))
                      : i.isNumber(o.y) && (t.f = o.y)),
      ...
      function(t, e, n) {
        ...
        (l.prototype.init = function(t, e) {
            ...
            (this.viewport = a(
              r.getOrCreateViewport(this.svg, this.options.viewportSelector),
              {
                ...
                beforeZoom: function(t, e) {
                  return n.viewport && n.options.beforeZoom
                    ? n.options.beforeZoom(t, e)
                    : void 0;
                },
                onZoom: function(t) {
                  return n.viewport && n.options.onZoom
                    ? n.options.onZoom(t)
                    : void 0;
                },
                beforePan: function(t, e) {
                  return n.viewport && n.options.beforePan
                    ? n.options.beforePan(t, e)
                    : void 0;
                },
                onPan: function(t) {
                  return n.viewport && n.options.onPan
                    ? n.options.onPan(t)
                    : void 0;
                },
                onUpdatedCTM: function(t) {
                  return n.viewport && n.options.onUpdatedCTM
                    ? n.options.onUpdatedCTM(t)
                    : void 0;
                }
              }
            ));
            ...
            if (
              ...
              if (n && n.length)
                for (var o = n.length - 1; o >= 0; o--)
                  this.eventListeners.hasOwnProperty(n[o]) &&
                    delete this.eventListeners[n[o]];
            }
            ...
            if (this.options.zoomEnabled && "none" === this.state) {
              ...
              (this.lastMouseWheelEventTime = Date.now()),
                ...
                (e =
                  e > -0.3 && 0.3 > e
                    ? e
                    : (e > 0 ? 1 : -1) * Math.log(Math.abs(e) + 10) / o);
          ...
          (l.prototype.zoomAtPoint = function(t, e, n) {
            ...
            n
              ? ((t = Math.max(
                  ...
                  Math.min(this.options.maxZoom * o.zoom, t)
                )),
                (t /= this.getZoom()))
              : this.getZoom() * t < this.options.minZoom * o.zoom
                ? (t = this.options.minZoom * o.zoom / this.getZoom())
                : this.getZoom() * t > this.options.maxZoom * o.zoom &&
                  (t = this.options.maxZoom * o.zoom / this.getZoom());
          ...
          (l.prototype.publicZoomAtPoint = function(t, e, n) {
            if (
              (n && (t = this.computeFromRelativeZoom(t)),
          ...
          (l.prototype.center = function() {
            var t = this.viewport.getViewBox(),
              ...
              n = 0.5 * (this.height - (t.height + 2 * t.y) * this.getZoom());
        ...
        var h = [],
          c = function(t, e) {
            ...
            return (
              h.push({ svg: n, instance: new l(n, e) }),
        ...
        document.documentMode && (i = "ie"),
          (e.exports = {
            ...
            refreshDefsGlobal: o.throttle(function() {
              for (
                var t = document.querySelectorAll("defs"), e = t.length, n = 0;
                e > n;
                n++
              ) {
                var o = t[n];
              ...
              return (
                "mousewheel" == u
                  ? ((n.deltaY = -1 / 40 * t.wheelDelta),
                    t.wheelDeltaX && (n.deltaX = -1 / 40 * t.wheelDeltaX))
                  : (n.deltaY = t.detail),
                e(n)
              );
            };
            return c.push({ element: t, fn: o, capture: n }), o;
          }
          function e(t, e) {
